...
void main() {
  test('CLI review approve --json returns valid JSON payload', () async {
    final temp = Directory.systemTemp.createTempSync(
      'genaisys_review_approve_json_',
    );
    addTearDown(() {
  ...
  test(
    'CLI review approve --json returns JSON error when no active task',
    () async {
      final temp = Directory.systemTemp.createTempSync(
        'genaisys_review_approve_json_error_',
      );
      addTearDown(() {
        temp.deleteSync(recursive: true);
      });
